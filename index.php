...
<body>
     <!-- header -->
     <header>
        <h3 class="logo">Hafizh Izdihar Bintang</h3>
        ...
        <a href="img/cv_hafizh.png" class="top-btn">Lihat CV</a>
    </header>
    ...
    <section class="about" id="about">
	 <?php
      ...
      <div class="about-text">
            ...
            <a href="https://api.whatsapp.com/send?phone=<?php echo"$hasil_kami[3]";?>&text=Teks" class="btn">Kontak saya<img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" width="30px" height="30px"> </a>
        </div>
		<?php }?>
    </section>
    ...
    <section class="portfolio" id="portfolio">
        <div class="heading">
            ...
            <h2>
            Proyek Saya </h3>
            <p>berikut ini proyek yang telah saya buat <br> dengan baik dan benar</p>
        </div>
    ...
    <section class="service">
        <div class="heading" id="service">
            <h3>Keahlian</h2>
            <h2>Keahlian yang saya miliki</h3>
            <p></p>
        </div>
	...
	<section class="contact" id="contact">
		<div class="container">
			<div class="center">
				<h3>Kirim pesan sebagai kritik dan saran</h3>
				<p>kirim nama dan email anda.</p>
			</div>
	...
	<!--------ends---->
	<div class="ends">
		<p>Pembuat Hafizh Izdihar © 2025 |<a href="admin/login.php">Masuk Sebagai Admin</a></p>
	</div>
